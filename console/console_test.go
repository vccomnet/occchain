...
import (
	...
	"github.com/blockchain/go-blockchain/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Blockchain service within
	...
	ethConf := &eth.Config{
		...
		Occerbase: common.HexToAddress(testAddress),
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return eth.New(ctx, ethConf) }); err != nil {
		t.Fatalf("failed to register Blockchain protocol: %v", err)
	}
