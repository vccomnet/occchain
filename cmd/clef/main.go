...
import (
	...
	"github.com/blockchain/go-blockchain/signer/core"
	"github.com/blockchain/go-blockchain/signer/rules"
	"github.com/blockchain/go-blockchain/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Blockchain account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
