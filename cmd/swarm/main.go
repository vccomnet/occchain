...
import (
	...
	"github.com/blockchain/go-blockchain/swarm"
	bzzapi "github.com/blockchain/go-blockchain/swarm/api"
	swarmmetrics "github.com/blockchain/go-blockchain/swarm/metrics"
...
// This init function sets defaults so cmd/swarm can run alongside occ.
func init() {
...
var app = utils.NewApp("", "Blockchain Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-blockchain Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//occ only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for occ and swarm
	...
	//register BZZ as node.Service in the blockchain node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the blockchain node
