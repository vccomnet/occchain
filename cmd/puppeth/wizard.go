...
type wizard struct {
	...
	services map[string][]string   // Blockchain services known to be running on servers
...
// converts it to an Blockchain address. If an empty line is entered, the default
// value is returned.
