...
// setting up a new or managing an existing Blockchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Blockchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Blockchain network down to  |")
	...
	log.Info("Administering Blockchain network", "name", w.network)
