...
const (
	...
	MessageType_MessageType_BlockchainGetAddress       MessageType = 56
	MessageType_MessageType_BlockchainAddress          MessageType = 57
	MessageType_MessageType_BlockchainSignTx           MessageType = 58
	MessageType_MessageType_BlockchainTxRequest        MessageType = 59
	MessageType_MessageType_BlockchainTxAck            MessageType = 60
	...
	MessageType_MessageType_BlockchainSignMessage      MessageType = 64
	MessageType_MessageType_BlockchainVerifyMessage    MessageType = 65
	MessageType_MessageType_BlockchainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_BlockchainGetAddress",
	57:  "MessageType_BlockchainAddress",
	58:  "MessageType_BlockchainSignTx",
	59:  "MessageType_BlockchainTxRequest",
	60:  "MessageType_BlockchainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_BlockchainSignMessage",
	65:  "MessageType_BlockchainVerifyMessage",
	66:  "MessageType_BlockchainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_BlockchainGetAddress":       56,
	"MessageType_BlockchainAddress":          57,
	"MessageType_BlockchainSignTx":           58,
	"MessageType_BlockchainTxRequest":        59,
	"MessageType_BlockchainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_BlockchainSignMessage":      64,
	"MessageType_BlockchainVerifyMessage":    65,
	"MessageType_BlockchainMessageSignature": 66,
...
// *
// Request: Ask device for Blockchain address corresponding to address_n path
// @next PassphraseRequest
// @next BlockchainAddress
// @next Failure
...
func (m *BlockchainGetAddress) Reset()                    { *m = BlockchainGetAddress{} }
func (m *BlockchainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*BlockchainGetAddress) ProtoMessage()               {}
func (*BlockchainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *BlockchainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *BlockchainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Blockchain address derived from device private seed
// @prev BlockchainGetAddress
...
func (*BlockchainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next BlockchainTxRequest
// @next Failure
type BlockchainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *BlockchainSignTx) Reset()                    { *m = BlockchainSignTx{} }
func (m *BlockchainSignTx) String() string            { return proto.CompactTextString(m) }
func (*BlockchainSignTx) ProtoMessage()               {}
func (*BlockchainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *BlockchainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *BlockchainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *BlockchainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *BlockchainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *BlockchainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *BlockchainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *BlockchainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *BlockchainSignTx) GetDataLength() uint32 {
...
func (m *BlockchainSignTx) GetChainId() uint32 {
...
// @prev BlockchainSignTx
// @next BlockchainTxAck
type BlockchainTxRequest struct {
...
func (m *BlockchainTxRequest) Reset()                    { *m = BlockchainTxRequest{} }
func (m *BlockchainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*BlockchainTxRequest) ProtoMessage()               {}
func (*BlockchainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *BlockchainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *BlockchainTxRequest) GetSignatureV() uint32 {
...
func (m *BlockchainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *BlockchainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev BlockchainTxRequest
// @next BlockchainTxRequest
type BlockchainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *BlockchainTxAck) Reset()                    { *m = BlockchainTxAck{} }
func (m *BlockchainTxAck) String() string            { return proto.CompactTextString(m) }
func (*BlockchainTxAck) ProtoMessage()               {}
func (*BlockchainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *BlockchainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next BlockchainMessageSignature
// @next Failure
type BlockchainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *BlockchainSignMessage) Reset()                    { *m = BlockchainSignMessage{} }
func (m *BlockchainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*BlockchainSignMessage) ProtoMessage()               {}
func (*BlockchainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *BlockchainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *BlockchainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type BlockchainVerifyMessage struct {
...
func (m *BlockchainVerifyMessage) Reset()                    { *m = BlockchainVerifyMessage{} }
func (m *BlockchainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*BlockchainVerifyMessage) ProtoMessage()               {}
func (*BlockchainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *BlockchainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *BlockchainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *BlockchainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev BlockchainSignMessage
type BlockchainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *BlockchainMessageSignature) Reset()                    { *m = BlockchainMessageSignature{} }
func (m *BlockchainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*BlockchainMessageSignature) ProtoMessage()               {}
func (*BlockchainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *BlockchainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *BlockchainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BlockchainGetAddress)(nil), "BlockchainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*BlockchainAddress)(nil), "BlockchainAddress")
	...
	proto.RegisterType((*BlockchainSignTx)(nil), "BlockchainSignTx")
	proto.RegisterType((*BlockchainTxRequest)(nil), "BlockchainTxRequest")
	proto.RegisterType((*BlockchainTxAck)(nil), "BlockchainTxAck")
	proto.RegisterType((*BlockchainSignMessage)(nil), "BlockchainSignMessage")
	proto.RegisterType((*BlockchainVerifyMessage)(nil), "BlockchainVerifyMessage")
	proto.RegisterType((*BlockchainMessageSignature)(nil), "BlockchainMessageSignature")
