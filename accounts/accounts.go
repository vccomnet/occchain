...
// Package accounts implements high level Blockchain account management.
package accounts
...
// Account represents an Blockchain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Blockchain account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain blockchain.ChainStateReader)
