...
// Package bind generates Blockchain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-blockchain Wiki page:
// https://github.com/blockchain/go-blockchain/wiki/Native-DApps:-Go-bindings-to-Blockchain-contracts
package bind
