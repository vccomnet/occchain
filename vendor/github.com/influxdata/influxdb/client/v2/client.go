...
// Ping returns how long the request took, the version of the server it connected to, and an error if one gethurred.
...
// It returns nil if no errors gethurred on any statements.
