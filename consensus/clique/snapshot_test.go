...
// mapped from textual names used in the tests below to actual Blockchain private
...
// address retrieves the Blockchain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Blockchain address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/blockchain/go-blockchain/issues/17593). Whilst this
