...
// ecrecover extracts the Blockchain account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Blockchain address
...
// Blockchain testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Blockchain address of the signing key
...
// Author implements consensus.Engine, returning the Blockchain address recovered
