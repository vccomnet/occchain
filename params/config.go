...
var (
	...
	MainnetGenesisHash = common.HexToHash("0x8e9ecb8aa5793e8c553eb12fbb2158dc93a54e188f2a90b569cc1dc93a1a14e6")
...
var (
	...
	// and accepted by the Blockchain core developers into the Ethash consensus.
	//
	...
	// and accepted by the Blockchain core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/blockchain/EIPs/issues/150)
