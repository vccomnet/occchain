...
// Whisper represents a dark communication interface through the Blockchain
...
// New creates a Whisper client ready to communicate through the Blockchain P2P network.
