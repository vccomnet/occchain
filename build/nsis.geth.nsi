...
# 1. install occ for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for occ
# 5. create occ, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable BLOCKCHAIN_SOCKET
...
!define GROUPNAME "Blockchain"
!define APPNAME "Geth"
!define DESCRIPTION "Official Go implementation of the Blockchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since occ is installed global
