...
var (
	...
	authorsFileHeader = "# This is the official list of go-blockchain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-blockchain Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-blockchain"
	}
	if startOfSentence {
		return "The go-blockchain library"
	}
	return "the go-blockchain library"
}
