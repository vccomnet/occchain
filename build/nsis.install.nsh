Name "occ ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/blockchain/go-blockchain/issues"
!define UPDATEURL "https://github.com/blockchain/go-blockchain/releases"
!define ABOUTURL "https://github.com/blockchain/go-blockchain#blockchain-go"
...
# Install occ binary
Section "Geth" GOCC_IDX
  SetOutPath $INSTDIR
  file {{.Geth}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\occ.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\occ.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:40404)" ""  6 1 1 2147483647 1 "$INSTDIR\occ.exe" "" "" "Blockchain" 40404 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:40404)" ""  6 2 1 2147483647 1 "$INSTDIR\occ.exe" "" "" "Blockchain" "" 40404 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:40404)" "" 17 2 1 2147483647 1 "$INSTDIR\occ.exe" "" "" "Blockchain" "" 40404 "" ""

  # Set default IPC endpoint (https://github.com/blockchain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "BLOCKCHAIN_SOCKET" "R" "HKLM" "\\.\pipe\occ.ipc"
  ${EnvVarUpdate} $0 "BLOCKCHAIN_SOCKET" "A" "HKLM" "\\.\pipe\occ.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GOCC_IDX}
    SectionGetSize ${GOCC_IDX} $0
