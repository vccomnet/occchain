...
// Package chequebook package wraps the 'chequebook' Blockchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in occer; (auto)cashing cheques in occer
// as well as (auto)depositing occer to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/blockchain/go-blockchain/contracts/chequebook/contract"
	...
	"github.com/blockchain/go-blockchain/swarm/services/swap/swap"
)
...
// * depositing occer to the chequebook
// * watching incoming occer
...
// Cash cashes the cheque by sending an Blockchain transaction.
