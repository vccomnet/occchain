...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "occ.ipc", false, filepath.Join(os.TempDir(), "occ.ipc")},
		{"data", "occ.ipc", false, "data/occ.ipc"},
		{"data", "./occ.ipc", false, "./occ.ipc"},
		{"data", "/occ.ipc", false, "/occ.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "occ.ipc", true, `\\.\pipe\occ.ipc`},
		{"data", "occ.ipc", true, `\\.\pipe\occ.ipc`},
		{"data", `\\.\pipe\occ.ipc`, true, `\\.\pipe\occ.ipc`},
	}
