...
// Package p2p implements the Blockchain p2p network protocols.
package p2p
...
import (
	...
	"github.com/blockchain/go-blockchain/p2p/discover"
	"github.com/blockchain/go-blockchain/p2p/discv5"
	"github.com/blockchain/go-blockchain/p2p/enode"
	"github.com/blockchain/go-blockchain/p2p/enr"
...
func (srv *Server) setupDiscovery() error {
	...
	if srv.NAT != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(srv.NAT, srv.quit, "udp", realaddr.Port, realaddr.Port, "blockchain discovery")
		}
	}
...
func (srv *Server) setupListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "blockchain p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Blockchain Node Record
