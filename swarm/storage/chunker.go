...
import (
	...
	ch "github.com/blockchain/go-blockchain/swarm/chunk"
...
type JoinerParams struct {
	...
	addr   Address
	getter Getter
	// TODO: there is a bug, so depth can only be 0 today, see: https://github.com/occersphere/go-blockchain/issues/344
	depth int
	ctx   context.Context
}
