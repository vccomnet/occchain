...
import (
	...
	"github.com/blockchain/go-blockchain/swarm/multihash"
	"github.com/blockchain/go-blockchain/swarm/spancontext"
	"github.com/blockchain/go-blockchain/swarm/storage"
	"github.com/blockchain/go-blockchain/swarm/storage/feed"
	"github.com/blockchain/go-blockchain/swarm/storage/feed/lookup"
...
it is the public interface of the FileStore which is included in the blockchain stack
*/
type API struct {
	feed      *feed.Handler
