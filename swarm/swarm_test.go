...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/occ.ipc",
			endpoint:    "/data/testnet/occ.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/occ.ipc",
			endpoint:    "/data/testnet/occ.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/occ.ipc",
			endpoint:    "/data/testnet/occ.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/occ.ipc",
			endpoint:    "/data/testnet/occ.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
...
// https://github.com/occersphere/go-blockchain/issues/639
