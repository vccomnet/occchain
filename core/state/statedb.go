...
// Package state provides a caching layer atop the Blockchain state trie.
package state
...
// StateDBs within the blockchain protocol are used to store anything
...
//
// Carrying over the balance ensures that Occer doesn't disappear.
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/blockchain/go-blockchain/pull/16485#issuecomment-380438527),
