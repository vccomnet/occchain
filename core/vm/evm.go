...
type Context struct {
	...
	// sufficient occer to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers occer from one account to the other
...
// EVM is the Blockchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) blockchain virtual machine
