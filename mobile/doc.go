...
// Package occ contains the simplified mobile APIs to go-blockchain.
//
// The scope of this package is *not* to allow writing a custom Blockchain client
// with pieces plucked from go-blockchain, rather to allow writing native dapps on
...
// from the go-blockchain repository. Please adhere to this scoping to prevent this
// package getting unmaintainable.
//
// Wrapping guidelines:
//
// Every type that is to be exposed should be wrapped into its own plain struct,
// which internally contains a single field: the original go-blockchain version.
