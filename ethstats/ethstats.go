...
// Service implements an Blockchain netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Blockchain      // Full Blockchain service if monitoring a full node
	les    *les.LightBlockchain // Light Blockchain service if monitoring a light node
...
func New(url string, ethServ *eth.Blockchain, lesServ *les.LightBlockchain) (*Service, error) {
