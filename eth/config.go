...
// DefaultConfig contains default settings for use on the Blockchain main net.
...
type Config struct {
	...
	// If nil, the Blockchain main net block is used.
	...
	Occerbase      common.Address `toml:",omitempty"`
