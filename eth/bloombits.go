...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Blockchain
...
func (eth *Blockchain) startBloomHandlers(sectionSize uint64) {
...
// for the Blockchain header bloom filters, permitting blazing fast filtering.
