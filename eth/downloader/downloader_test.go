...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", blockchain.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", blockchain.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", blockchain.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", blockchain.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want blockchain.SyncProgress) {
	t.Helper()
	p := d.Progress()
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", blockchain.SyncProgress{
