...
// Syncing provides information when this nodes starts synchronising with the Blockchain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  blockchain.SyncProgress `json:"status"`
}
